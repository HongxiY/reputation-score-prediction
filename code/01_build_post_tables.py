...
Output: processed/workplace_posts.json   [{id, created_time, message_clean, group_name}]
        processed/yammer_messages.json   [{id, created_at, body, group_name}]

Usage:
    python code/01_build_post_tables.py
"""
